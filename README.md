...
![اجرای نهایی ۳۱ تست](docs/evidence/finalJaCoCo.png)
...
- [رونوشت کامل تعامل‌ها با CODEX](CODEX.md)

این فایل شامل promptها، پاسخ‌ها و روند تعامل است و به‌عنوان ضمیمهٔ گزارش ارائه می‌شود.
